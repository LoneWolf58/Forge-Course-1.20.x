...
import net.marshall.mccourse.block.custom.AlexandriteLampBlock;
import net.marshall.mccourse.block.custom.GemEmpoweringStationBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ALEXANDRITE_BUTTON = registerBlock("alexandrite_button",
            () -> new ButtonBlock(BlockBehaviour.Properties.copy(Blocks.GRANITE_SLAB).sound(SoundType.METAL), BlockSetType.IRON, 10,
                    true));
