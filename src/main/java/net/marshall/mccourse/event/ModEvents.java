...
import net.marshall.mccourse.command.ReturnHomeCommand;
import net.marshall.mccourse.command.SetHomeCommand;
import net.marshall.mccourse.item.ModItems;
import net.marshall.mccourse.item.custom.HammerItem;
...
public class ModEvents {
    ...
    public static void addCustomTrades(VillagerTradesEvent event) {
        ...
        if(event.getType() == ModVillagers.SOUND_MASTER.get()) {
            ...
            trades.get(villagerLevel).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemStack(ModItems.ALEXANDRITE.get(), 25), stack, 2, 5, 0.06f
            ));
        }
    }
